...
>
> **The specification may be supplied either way** — it is instruction,
> not an artifact committed byte-for-byte, and a transport layer that
> alters its whitespace changes nothing that matters.
>
...
**Determine the register's complete membership yourself.** The five
...
**A0 — Commit order and paths, frozen.**
    ...
    commit 1  specs/2026-08-XXT{HHMM}Z_supply-protocol-v2.md
    commit 2  reviews/chatgpt/2026-08-XXT{HHMM}Z_supply-protocol-v2.md
    commit 3  CONVENTIONS.md, docs/BRANCHING_POLICY.md, DECISION_LOG.md
    commit 4  reports/2026-08-XXT{HHMM}Z_supply-protocol-v2.md
...
`2337`**, which the superseded first issue used. **Commit 2 precedes
the work**, per Rule 15.
...
**A6 — Register membership determined**, per §1: **all five known
...
**A9 — Scope**, three additions and three modifications:
    ...
    add:
      specs/2026-08-XXT{HHMM}Z_supply-protocol-v2.md
      reviews/chatgpt/2026-08-XXT{HHMM}Z_supply-protocol-v2.md
      reports/2026-08-XXT{HHMM}Z_supply-protocol-v2.md
    modify:
      CONVENTIONS.md
      docs/BRANCHING_POLICY.md
      DECISION_LOG.md
...
- Branch naming: use `governance/supply-protocol-v2`. **The first
  issue's branch is preserved at `7146a093…`, superseded for
...
- **A6's enumeration**: every remote branch classified, with your reason
  for any addition to the register beyond the FIVE supplied;
