...
## 5. Commit order and evidence layering
    ...
    commit 1  specs/2026-08-XXT{HHMM}Z_integrate-enforcement-checks.md
    commit 2  reviews/chatgpt/2026-08-XXT{HHMM}Z_integrate-enforcement-checks.md
    commit 3  --no-ff merge of the pinned remote ref
    commit 4  reports/2026-08-XXT{HHMM}Z_integrate-enforcement-checks.md
...
`fe8de65de8288593f39a74110c1ea370ce27021f`. Any mismatch → STOP.
**Local `main` is stale by design.**
...
**A5 — Scope, frozen manifest. Final base-to-head scope: 9 additions and
0 modifications.**
    ...
    add:
      ...
      reports/2026-08-XXT{HHMM}Z_integrate-enforcement-checks.md
      reviews/chatgpt/2026-08-12T1256Z_governance-enforcement.md
      reviews/chatgpt/2026-08-XXT{HHMM}Z_integrate-enforcement-checks.md
      scripts/governance_tools/task_checker.py
      specs/2026-08-12T1256Z_governance-enforcement.md
      specs/2026-08-XXT{HHMM}Z_integrate-enforcement-checks.md
...
specification**: A5's governing sentence states nine additions
immediately before its scope block, and the manifest lists nine paths.
...
- **Do not delete any branch**, including the six in the register.
...
- Branch naming: use `governance/integrate-enforcement-checks`.
